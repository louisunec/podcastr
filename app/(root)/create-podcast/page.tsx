  ...
  return (
    <section className="mt-10 flex flex-col">
      ...
      <Form {...form}>
        ...
        >
          <div className="flex flex-col gap-[30px] border-b pb-10
          border-black-5">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col gap-2.5">
                  ...
                  <FormControl>
                    <Input
                      placeholder="Lucxy Pro Podcast" {...field}
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <Select onValueChange={(value) => setVoiceType(value)}>
                ...
                bg-black-1 text-gray-1 focus:ring-offset-orange-1`)}>
                  <SelectValue 
                ...
                text-white-1 focus:ring-offset-orange-1">
