  ...
  return (
    <div className={cn(`sticky bottom-0 left-0 flex size-full flex-col`, {
        ...
        <Progress 
            ...
            max={duration}
        />
        <section className="glassmorphism-black flex h-[112px] w-full
        ...
        max-md:gap-5 md:px-12">
            ...
            <div className="flex items-center gap-4 max-md:hidden">
                <Link href={`/podcast/${audio?.podcastId}`}>
                    <Image 
                        src={audio?.imageUrl! || "/images/palyer1.png"}
                        alt="player"
                        width={64}
                        height={64}
                ...
                <div className="flex w-[160px] flex-col">
                    ...
                    <p className='text-white-2 text-12 font-normal'>{audio?.author}</p>
                </div>
            </div>
